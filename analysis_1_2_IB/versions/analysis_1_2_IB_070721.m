...
%
%      ANALYSIS_1_2_IB_070721, by itself, creates a new ANALYSIS_1_2_IB_070721 or raises the existing
%      singleton*.
%
%      H = ANALYSIS_1_2_IB_070721 returns the handle to a new ANALYSIS_1_2_IB_070721 or the handle to
%      the existing singleton*.
%
%      ANALYSIS_1_2_IB_070721('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANALYSIS_1_2_IB_070721.M with the given input arguments.
%
%      ANALYSIS_1_2_IB_070721('Property','Value',...) creates a new ANALYSIS_1_2_IB_070721 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before analysis_1_2_IB_070721_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to analysis_1_2_IB_070721_OpeningFcn via varargin.
%
...
%
function varargout = analysis_1_2_IB_070721(varargin)
% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @analysis_1_2_IB_070721_OpeningFcn, ...
                   'gui_OutputFcn',  @analysis_1_2_IB_070721_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% varargin   command line arguments to analysis_1_2_IB_070721 (see VARARGIN)
%
function analysis_1_2_IB_070721_OpeningFcn(hObject, eventdata, handles, varargin)
% Choose default command line output for analysis_1_2_IB_070721
...
% handles    structure with handles and user data (see GUIDATA)
%
function varargout = analysis_1_2_IB_070721_OutputFcn(hObject, eventdata, handles) 
