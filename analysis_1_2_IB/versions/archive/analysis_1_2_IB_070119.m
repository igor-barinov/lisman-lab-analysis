function varargout = analysis_1_2_IB_070119(varargin)
% analysis_1_2_IB_070119 MATLAB code for analysis_1_2_IB_070119.fig
%      analysis_1_2_IB_070119, by itself, creates a new analysis_1_2_IB_070119 or raises the existing
%      singleton*.
%
%      H = analysis_1_2_IB_070119 returns the handle to a new analysis_1_2_IB_070119 or the handle to
%      the existing singleton*.
%
%      analysis_1_2_IB_070119('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in analysis_1_2_IB_070119.M with the given input arguments.
%
%      analysis_1_2_IB_070119('Property','Value',...) creates a new analysis_1_2_IB_070119 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before analysis_1_2_IB_070119_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to analysis_1_2_IB_070119_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help analysis_1_2_IB_070119

% Last Modified by GUIDE v2.5 15-Jul-2019 13:39:41
...
% --- Executes just before analysis_1_2_IB_070119 is made visible.
function analysis_1_2_IB_070119_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to analysis_1_2_IB_070119 (see VARARGIN)

% Choose default command line output for analysis_1_2_IB_070119
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes analysis_1_2_IB_070119 wait for user response (see UIRESUME)
