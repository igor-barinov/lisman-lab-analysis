...
% 'stats_IB_061020'
%
function varargout = stats_IB_061020(varargin)
% STATS_IB_061020 MATLAB code for stats_IB_061020.fig
%      STATS_IB_061020, by itself, creates a new STATS_IB_061020 or raises the existing
%      singleton*.
%
%      H = STATS_IB_061020 returns the handle to a new STATS_IB_061020 or the handle to
%      the existing singleton*.
%
%      STATS_IB_061020('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in STATS_IB_061020.M with the given input arguments.
%
%      STATS_IB_061020('Property','Value',...) creates a new STATS_IB_061020 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before stats_IB_061020_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to stats_IB_061020_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help stats_IB_061020

% Last Modified by GUIDE v2.5 17-Jul-2020 15:08:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @stats_IB_061020_OpeningFcn, ...
                   'gui_OutputFcn',  @stats_IB_061020_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before stats_IB_061020 is made visible.
function stats_IB_061020_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to stats_IB_061020 (see VARARGIN)

% Choose default command line output for stats_IB_061020
...
function varargout = stats_IB_061020_OutputFcn(hObject, eventdata, handles) 
...
try
    scriptFilePath = which('stats_IB_061020');
    [path, ~, ~] = fileparts(scriptFilePath);
    logFile = 'stats_IB_061020_LOG.txt';
