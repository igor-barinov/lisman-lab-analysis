...
% beta0(4): tau2
% beta0(5): delta peak time of final data fit
% beta0(6): gaussian width of IRF
...
t = x * spc.datainfo.psPerUnit/1000;

%{
% ********* Exponential calculation ************
decay_param = (beta0(6)^2 * beta0(2)^2)/2 - beta0(2)*(x - beta0(5));
pulse_param = (beta0(6)^2 * beta0(2) - (x - beta0(5))) / (beta0(6)*sqrt(2));
decay = beta0(1)/2*exp(decay_param);
pulse = erfc(pulse_param);
y = decay.*pulse;
%}
