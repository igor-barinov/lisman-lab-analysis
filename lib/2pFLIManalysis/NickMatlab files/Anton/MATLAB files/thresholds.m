...
% Last Modified by GUIDE v2.5 22-Jan-2016 15:14:19
...
function bmfg_Callback(hObject, eventdata, handles)
% hObject    handle to bmfg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of bmfg as text
%        str2double(get(hObject,'String')) returns contents of bmfg as a double
global thresholds_list;
...
% --- Executes during object creation, after setting all properties.
function bmfg_CreateFcn(hObject, eventdata, handles)
% hObject    handle to bmfg (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
global thresholds_list;
sgb = str2double(get(hObject,'String'));
thresholds_list(19) = sgb;
...
global thresholds_list;
bmfg = str2double(get(hObject,'String'));
thresholds_list(20) = bmfg;
...
function imagealign_Callback(hObject, eventdata, handles)
% hObject    handle to imagealign (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of imagealign as text
%        str2double(get(hObject,'String')) returns contents of imagealign as a double
global imagealign;
imagealign = str2double(get(hObject,'String'));



% --- Executes during object creation, after setting all properties.
function imagealign_CreateFcn(hObject, eventdata, handles)
% hObject    handle to imagealign (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
