...
% Last Modified by GUIDE v2.5 03-Feb-2014 15:25:47
global gui;
global spc;
...
cd (pname);
filestr = [pname, fname];
    spc.fit.range = [10.5, 41];         %added by Julia, changes fitstart & end times to 2.1 & 8
if exist(filestr) == 2
...
% --- Executes during object creation, after setting all properties.
function beta_txt4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to beta_txt4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- Executes on key press with focus on beta2 and none of its controls.
function beta2_KeyPressFcn(hObject, eventdata, handles)
...
function beta1_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to beta1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on key press with focus on beta1 and none of its controls.
function beta1_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to beta1 (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
%	Key: name of the key that was pressed, in lower case
%	Character: character interpretation of the key(s) that was pressed
