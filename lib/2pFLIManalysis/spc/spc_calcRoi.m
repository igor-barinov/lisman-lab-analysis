...
if ~spc.switches.noSPC
    %fig_content = {'tau_m', 'int_int2', 'red_int2'};    % modified by NO and JZ
    %fig_yTitle = {'tau_m', 'Intensity(Green)', 'Intensity(Red)'}; % modified by NO and JZ
    fig_content = {'tau_m', 'mean_int', 'red_int2'};    % modified by NO and JZ
    fig_yTitle = {'tau_m', 'Intensity(Green)', 'Intensity(Red)'}; % modified by NO and JZ
