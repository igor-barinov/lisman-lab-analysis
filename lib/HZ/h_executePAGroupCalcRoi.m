function h_executeGroupCalcRoi

global h_img

handles = h_img.currentHandles;

set(handles.pausePAGroupCalc,'Enable','on');
UserData = get(handles.paAnalysis,'UserData');
UserData.pausePAGroupCalc.Enable = 'on';
...
set(handles.pausePAGroupCalc,'Enable','off');
UserData = get(handles.paAnalysis,'UserData');
UserData.pausePAGroupCalc.Enable = 'off';
set(handles.paAnalysis,'UserData',UserData);
