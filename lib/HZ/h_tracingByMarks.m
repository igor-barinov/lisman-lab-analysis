...
delete(findobj(handles.imageAxes,'tag', 'h_dendriteSkeleton'));
hold on;
...
% hold on,plot(Aout.roiCentroid_g(:,1),Aout.roiCentroid_g(:,2),'+','markersize',12);

Aout.voxelSize = scale;
motor = h_img.header.motor;
Aout.firstFrameAbsPos = [-motor.absXPosition, motor.absYPosition - yFOV, motor.absZPosition];    
