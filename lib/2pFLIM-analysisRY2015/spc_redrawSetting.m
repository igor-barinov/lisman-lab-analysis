...
% spc.SPCdata.scan_rout_x =1; % nicko commented to be able to open tiff file!!!
...
set(gui.spc.figure.projectImage, 'CData', spc.project);   %DISPLAYS IMAGE IN FIGPROJECT nicko
...
if ~spc.switches.noSPC %Start IB Mod
