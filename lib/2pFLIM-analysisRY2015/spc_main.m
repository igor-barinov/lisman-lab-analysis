...
% Last Modified by GUIDE v2.5 14-Jun-2019 21:43:26
global gui;
global spc;
...
elseif ischar(varargin{1}) % INVOKE NAMED SUBFUNCTION OR CALLBACK
	...
	try
        ...
        disp('Error: Unable to find premade ROIs');
		disp(lasterr);
	end
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over spc_page.
function spc_page_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to spc_page (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
