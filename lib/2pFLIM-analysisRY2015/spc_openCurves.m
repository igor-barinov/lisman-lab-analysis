...
%  imagealign =1;
if imagealign ==1;
            if ~no_lastProject   % next commented lines are to calculate a shift between
                bg = 0;          %  images and adjuct ROIs positions in Fig 1: Projection, commented by nicko
                ...
                if nRoi > 0
                    ...
                    prj1 = spc.project-bg;       % next  lines are to calculate a shift between
                    prj2 = spc.lastProject-bg;   %  images and adjuct ROIs positions in Fig 1: Projection, commented by nicko
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    This is for the correction of the
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    image drift for poly Rois
